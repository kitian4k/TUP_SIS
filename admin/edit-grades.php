...
<html lang="en">
  <head>
    ...
    <title>TUP SIS | EDIT GRADES</title>
    <!-- plugins:css -->
             ...
             <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page"> EDIT GRADES</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">EDIT GRADES</h4>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">SUBJ #1 GRADE</th>
                            <th class="font-weight-bold">SUBJ #2 GRADE</th>
                            <th class="font-weight-bold">SUBJ #3 GRADE</th>
